  ...
  "node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e) {
      ...
      return function r2(o, i, u2) {
        ...
        for (var a2 = "function" == typeof __require && __require, e = 0; e < u2.length; e++)
          s(u2[e]);
        return s;
      }({ 1: [function(w, b2, m2) {
        !(function(e, n2, s, c, d, h, p, g2, y2) {
          "use strict";
          var r2 = w("crypto");
          function t(e2, t2) {
            t2 = u2(e2, t2);
            var n3;
            return void 0 === (n3 = "passthrough" !== t2.algorithm ? r2.createHash(t2.algorithm) : new l2()).write && (n3.write = n3.update, n3.end = n3.update), f2(t2, n3).dispatch(e2), n3.update || n3.end(""), n3.digest ? n3.digest("buffer" === t2.encoding ? void 0 : t2.encoding) : (e2 = n3.read(), "buffer" !== t2.encoding ? e2.toString(t2.encoding) : e2);
          }
          ...
          function f2(o2, t2, i2) {
            ...
            return { dispatch: function(e2) {
              ...
              if (i2.push(t3), void 0 !== s && s.isBuffer && s.isBuffer(t3))
                return u3("buffer:"), u3(t3);
              if ("object" === r3 || "function" === r3 || "asyncfunction" === r3)
                return e2 = Object.keys(t3), o2.unorderedObjects && (e2 = e2.sort()), false === o2.respectType || a2(t3) || e2.splice(0, 0, "prototype", "__proto__", "constructor"), o2.excludeKeys && (e2 = e2.filter(function(e3) {
              ...
              var n3 = this;
              if (u3("array:" + e2.length + ":"), !t3 || e2.length <= 1)
                return e2.forEach(function(e3) {
                  return n3.dispatch(e3);
                });
              var r3 = [], t3 = e2.map(function(e3) {
                var t4 = new l2(), n4 = i2.slice();
          ...
          !function(e3) {
            ...
            e3.toByteArray = function(e4) {
              ...
              for (t4 = 0; t4 < i3; t4 += 4, 0)
                s3((16711680 & (n4 = f3(e4.charAt(t4)) << 18 | f3(e4.charAt(t4 + 1)) << 12 | f3(e4.charAt(t4 + 2)) << 6 | f3(e4.charAt(t4 + 3)))) >> 16), s3((65280 & n4) >> 8), s3(255 & n4);
              ...
              for (t4 = 0, r4 = e4.length - i3; t4 < r4; t4 += 3)
                n4 = (e4[t4] << 16) + (e4[t4 + 1] << 8) + e4[t4 + 2], u4 += s3((o3 = n4) >> 18 & 63) + s3(o3 >> 12 & 63) + s3(o3 >> 6 & 63) + s3(63 & o3);
              switch (i3) {
                case 1:
        ...
        !(function(e2, n2, f2, r2, h, p, g2, y2, w) {
          ...
          function f2(e3, t2, n3) {
            if (!(this instanceof f2))
              return new f2(e3, t2, n3);
            var r3, o2, i2, u3, s2 = typeof e3;
            if ("base64" === t2 && "string" == s2)
              for (e3 = (u3 = e3).trim ? u3.trim() : u3.replace(/^\s+|\s+$/g, ""); e3.length % 4 != 0; )
                e3 += "=";
            if ("number" == s2)
              r3 = j2(e3);
            else if ("string" == s2)
              r3 = f2.byteLength(e3, t2);
            else {
              if ("object" != s2)
                throw new Error("First argument needs to be a number, array or string.");
              r3 = j2(e3.length);
            }
            if (f2._useTypedArrays ? o2 = f2._augment(new Uint8Array(r3)) : ((o2 = this).length = r3, o2._isBuffer = true), f2._useTypedArrays && "number" == typeof e3.byteLength)
              o2._set(e3);
            else if (C2(u3 = e3) || f2.isBuffer(u3) || u3 && "object" == typeof u3 && "number" == typeof u3.length)
              for (i2 = 0; i2 < r3; i2++)
                f2.isBuffer(e3) ? o2[i2] = e3.readUInt8(i2) : o2[i2] = e3[i2];
            else if ("string" == s2)
              o2.write(e3, 0, t2);
          ...
          function b2(e3, t2, n3, r3) {
            return f2._charsWritten = c(function(e4) {
              for (var t3 = [], n4 = 0; n4 < e4.length; n4++)
                t3.push(255 & e4.charCodeAt(n4));
              return t3;
            }(t2), e3, n3, r3);
          }
          function m2(e3, t2, n3, r3) {
            return f2._charsWritten = c(function(e4) {
              for (var t3, n4, r4 = [], o2 = 0; o2 < e4.length; o2++)
                n4 = e4.charCodeAt(o2), t3 = n4 >> 8, n4 = n4 % 256, r4.push(n4), r4.push(t3);
              return r4;
            }(t2), e3, n3, r3);
          }
          ...
          function o(e3, t2, n3, r3) {
            ...
            var o2, r3 = e3.length;
            if (!(r3 <= t2))
              return n3 ? (o2 = e3[t2], t2 + 1 < r3 && (o2 |= e3[t2 + 1] << 8)) : (o2 = e3[t2] << 8, t2 + 1 < r3 && (o2 |= e3[t2 + 1])), o2;
          }
          function u2(e3, t2, n3, r3) {
            ...
            var o2, r3 = e3.length;
            if (!(r3 <= t2))
              return n3 ? (t2 + 2 < r3 && (o2 = e3[t2 + 2] << 16), t2 + 1 < r3 && (o2 |= e3[t2 + 1] << 8), o2 |= e3[t2], t2 + 3 < r3 && (o2 += e3[t2 + 3] << 24 >>> 0)) : (t2 + 1 < r3 && (o2 = e3[t2 + 1] << 16), t2 + 2 < r3 && (o2 |= e3[t2 + 2] << 8), t2 + 3 < r3 && (o2 |= e3[t2 + 3]), o2 += e3[t2] << 24 >>> 0), o2;
          }
          function _2(e3, t2, n3, r3) {
            if (r3 || (d("boolean" == typeof n3, "missing or invalid endian"), d(null != t2, "missing offset"), d(t2 + 1 < e3.length, "Trying to read beyond buffer length")), !(e3.length <= t2))
              return r3 = o(e3, t2, n3, true), 32768 & r3 ? -1 * (65535 - r3 + 1) : r3;
          }
          function E2(e3, t2, n3, r3) {
            if (r3 || (d("boolean" == typeof n3, "missing or invalid endian"), d(null != t2, "missing offset"), d(t2 + 3 < e3.length, "Trying to read beyond buffer length")), !(e3.length <= t2))
              return r3 = u2(e3, t2, n3, true), 2147483648 & r3 ? -1 * (4294967295 - r3 + 1) : r3;
          }
          ...
          function s(e3, t2, n3, r3, o2) {
            ...
            if (!(o2 <= n3))
              for (var i2 = 0, u3 = Math.min(o2 - n3, 2); i2 < u3; i2++)
                e3[n3 + i2] = (t2 & 255 << 8 * (r3 ? i2 : 1 - i2)) >>> 8 * (r3 ? i2 : 1 - i2);
          }
          ...
          function L2(e3, t2, n3, r3, o2) {
            o2 || (d(null != t2, "missing value"), d("boolean" == typeof r3, "missing or invalid endian"), d(null != n3, "missing offset"), d(n3 + 3 < e3.length, "Trying to write beyond buffer length"), F2(t2, 2147483647, -2147483648)), e3.length <= n3 || l2(e3, 0 <= t2 ? t2 : 4294967295 + t2 + 1, n3, r3, o2);
          }
          ...
          H2.Buffer = f2, H2.SlowBuffer = f2, H2.INSPECT_MAX_BYTES = 50, f2.poolSize = 8192, f2._useTypedArrays = function() {
            ...
            switch ((!n3 || a3 < (n3 = Number(n3))) && (n3 = a3), r3 = String(r3 || "utf8").toLowerCase()) {
              ...
              case "utf8":
              case "utf-8":
                i2 = this, u3 = t2, s2 = n3, o2 = f2._charsWritten = c(T(e3), i2, u3, s2);
                break;
              case "ascii":
              case "binary":
                o2 = b2(this, e3, t2, n3);
                break;
              case "base64":
                i2 = this, u3 = t2, s2 = n3, o2 = f2._charsWritten = c(M2(e3), i2, u3, s2);
                break;
              case "ucs2":
              case "ucs-2":
              case "utf16le":
            ...
            if (e3 = String(e3 || "utf8").toLowerCase(), t2 = Number(t2) || 0, (n3 = void 0 !== n3 ? Number(n3) : s2.length) === t2)
              return "";
            switch (e3) {
              case "hex":
              ...
              case "utf-16le":
                r3 = function(e4, t3, n4) {
                  for (var r4 = e4.slice(t3, n4), o3 = "", i3 = 0; i3 < r4.length; i3 += 2)
            ...
            if (t2 = t2 || 0, (r3 = r3 || 0 === r3 ? r3 : this.length) !== (n3 = n3 || 0) && 0 !== e3.length && 0 !== this.length) {
              ...
              if (o2 < 100 || !f2._useTypedArrays)
                ...
                e3._set(this.subarray(n3, n3 + o2), t2);
            }
          }, f2.prototype.slice = function(e3, t2) {
            var n3 = this.length;
            if (e3 = S(e3, n3, 0), t2 = S(t2, n3, n3), f2._useTypedArrays)
              return f2._augment(this.subarray(e3, t2));
            for (var r3 = t2 - e3, o2 = new f2(r3, void 0, true), i2 = 0; i2 < r3; i2++)
              o2[i2] = this[i2 + e3];
            return o2;
            ...
            if (t2 = t2 || 0, n3 = n3 || this.length, d("number" == typeof (e3 = "string" == typeof (e3 = e3 || 0) ? e3.charCodeAt(0) : e3) && !isNaN(e3), "value is not a number"), d(t2 <= n3, "end < start"), n3 !== t2 && 0 !== this.length) {
              ...
              for (var r3 = t2; r3 < n3; r3++)
                this[r3] = e3;
            }
          }, f2.prototype.inspect = function() {
            for (var e3 = [], t2 = this.length, n3 = 0; n3 < t2; n3++)
              if (e3[n3] = k2(this[n3]), n3 === H2.INSPECT_MAX_BYTES) {
                e3[n3 + 1] = "...";
                break;
              }
            ...
            for (var e3 = new Uint8Array(this.length), t2 = 0, n3 = e3.length; t2 < n3; t2 += 1)
              e3[t2] = this[t2];
            return e3.buffer;
          };
          var t = f2.prototype;
          ...
          function T(e3) {
            for (var t2 = [], n3 = 0; n3 < e3.length; n3++) {
              ...
              if (r3 <= 127)
                t2.push(e3.charCodeAt(n3));
              else
                for (var o2 = n3, i2 = (55296 <= r3 && r3 <= 57343 && n3++, encodeURIComponent(e3.slice(o2, n3 + 1)).substr(1).split("%")), u3 = 0; u3 < i2.length; u3++)
                  t2.push(parseInt(i2[u3], 16));
            }
            return t2;
          }
          function M2(e3) {
          ...
          function c(e3, t2, n3, r3) {
            for (var o2 = 0; o2 < r3 && !(o2 + n3 >= t2.length || o2 >= e3.length); o2++)
              t2[o2 + n3] = e3[o2];
            return o2;
          }
          function N2(e3) {
        ...
        !(function(e2, t, a2, n2, r2, o, i, u2, s) {
          var a2 = c("buffer").Buffer, f2 = 4, l2 = new a2(f2);
          l2.fill(0);
          d.exports = { hash: function(e3, t2, n3, r3) {
            for (var o2 = t2(function(e4, t3) {
              e4.length % f2 != 0 && (n4 = e4.length + (f2 - e4.length % f2), e4 = a2.concat([e4, l2], n4));
              for (var n4, r4 = [], o3 = t3 ? e4.readInt32BE : e4.readInt32LE, i3 = 0; i3 < e4.length; i3 += f2)
                r4.push(o3.call(e4, i3));
              return r4;
            }(e3 = a2.isBuffer(e3) ? e3 : new a2(e3), r3), 8 * e3.length), t2 = r3, i2 = new a2(n3), u3 = t2 ? i2.writeInt32BE : i2.writeInt32LE, s2 = 0; s2 < o2.length; s2++)
              u3.call(i2, o2[s2], 4 * s2, true);
            return i2;
          } };
        }).call(this, c("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, c("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/crypto-browserify/helpers.js", "/node_modules/gulp-browserify/node_modules/crypto-browserify");
      }, { buffer: 3, lYpoI2: 11 }], 5: [function(v2, e, _2) {
        !(function(l2, c, u2, d, h, p, g2, y2, w) {
        ...
        !(function(e2, r2, o, i, u2, a2, f2, l2, y2) {
          var t = w("./helpers");
          function n2(e3, t2) {
          ...
          function c(e3, t2, n3, r3, o2, i2, u3) {
        ...
        !(function(e2, t2, n2, r2, o, i, u2, s, f2) {
          var a2;
          l2.exports = a2 || function(e3) {
            for (var t3, n3 = new Array(e3), r3 = 0; r3 < e3; r3++)
              0 == (3 & r3) && (t3 = 4294967296 * Math.random()), n3[r3] = t3 >>> ((3 & r3) << 3) & 255;
            return n3;
          };
        }).call(this, e("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/crypto-browserify/rng.js", "/node_modules/gulp-browserify/node_modules/crypto-browserify");
      }, { buffer: 3, lYpoI2: 11 }], 8: [function(c, d, e) {
        !(function(e2, t, n2, r2, o, s, a2, f2, l2) {
          var i = c("./helpers");
          function u2(l3, c2) {
            l3[c2 >> 5] |= 128 << 24 - c2 % 32, l3[15 + (c2 + 64 >> 9 << 4)] = c2;
            for (var e3, t2, n3, r3 = Array(80), o2 = 1732584193, i2 = -271733879, u3 = -1732584194, s2 = 271733878, d2 = -1009589776, h = 0; h < l3.length; h += 16) {
              for (var p = o2, g2 = i2, y2 = u3, w = s2, b2 = d2, a3 = 0; a3 < 80; a3++) {
                r3[a3] = a3 < 16 ? l3[h + a3] : v2(r3[a3 - 3] ^ r3[a3 - 8] ^ r3[a3 - 14] ^ r3[a3 - 16], 1);
        ...
        !(function(e2, t, n2, r2, u2, s, a2, f2, l2) {
          function b2(e3, t2) {
            var n3 = (65535 & e3) + (65535 & t2);
            return (e3 >> 16) + (t2 >> 16) + (n3 >> 16) << 16 | 65535 & n3;
          }
          function o(e3, l3) {
            ...
            for (var r3, o2, h = 0; h < e3.length; h += 16) {
              for (var i2 = t2[0], u3 = t2[1], s2 = t2[2], p = t2[3], a3 = t2[4], g2 = t2[5], y2 = t2[6], w = t2[7], f3 = 0; f3 < 64; f3++)
                n3[f3] = f3 < 16 ? e3[f3 + h] : b2(b2(b2((o2 = n3[f3 - 2], m2(o2, 17) ^ m2(o2, 19) ^ v2(o2, 10)), n3[f3 - 7]), (o2 = n3[f3 - 15], m2(o2, 7) ^ m2(o2, 18) ^ v2(o2, 3))), n3[f3 - 16]), c2 = b2(b2(b2(b2(w, m2(o2 = a3, 6) ^ m2(o2, 11) ^ m2(o2, 25)), a3 & g2 ^ ~a3 & y2), d2[f3]), n3[f3]), r3 = b2(m2(r3 = i2, 2) ^ m2(r3, 13) ^ m2(r3, 22), i2 & u3 ^ i2 & s2 ^ u3 & s2), w = y2, y2 = g2, g2 = a3, a3 = b2(p, c2), p = s2, s2 = u3, u3 = i2, i2 = b2(c2, r3);
          ...
          var i = c("./helpers"), m2 = function(e3, t2) {
            return e3 >>> t2 | e3 << 32 - t2;
          }, v2 = function(e3, t2) {
            return e3 >>> t2;
          };
        ...
        !(function(e2, t2, n2, r2, o, i, u2, s, a2) {
          f2.read = function(e3, t3, n3, r3, o2) {
            var i2, u3, l2 = 8 * o2 - r3 - 1, c = (1 << l2) - 1, d = c >> 1, s2 = -7, a3 = n3 ? o2 - 1 : 0, f3 = n3 ? -1 : 1, o2 = e3[t3 + a3];
            for (a3 += f3, i2 = o2 & (1 << -s2) - 1, o2 >>= -s2, s2 += l2; 0 < s2; i2 = 256 * i2 + e3[t3 + a3], a3 += f3, s2 -= 8)
              ;
          ...
          }, f2.write = function(e3, t3, l2, n3, r3, c) {
            var o2, i2, u3 = 8 * c - r3 - 1, s2 = (1 << u3) - 1, a3 = s2 >> 1, d = 23 === r3 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f3 = n3 ? 0 : c - 1, h = n3 ? 1 : -1, c = t3 < 0 || 0 === t3 && 1 / t3 < 0 ? 1 : 0;
            for (t3 = Math.abs(t3), isNaN(t3) || t3 === 1 / 0 ? (i2 = isNaN(t3) ? 1 : 0, o2 = s2) : (o2 = Math.floor(Math.log(t3) / Math.LN2), t3 * (n3 = Math.pow(2, -o2)) < 1 && (o2--, n3 *= 2), 2 <= (t3 += 1 <= o2 + a3 ? d / n3 : d * Math.pow(2, 1 - a3)) * n3 && (o2++, n3 /= 2), s2 <= o2 + a3 ? (i2 = 0, o2 = s2) : 1 <= o2 + a3 ? (i2 = (t3 * n3 - 1) * Math.pow(2, r3), o2 += a3) : (i2 = t3 * Math.pow(2, a3 - 1) * Math.pow(2, r3), o2 = 0)); 8 <= r3; e3[l2 + f3] = 255 & i2, f3 += h, i2 /= 256, r3 -= 8)
              ;
            for (o2 = o2 << r3 | i2, u3 += r3; 0 < u3; e3[l2 + f3] = 255 & o2, f3 += h, o2 /= 256, u3 -= 8)
              ;
            e3[l2 + f3 - h] |= 128 * c;
          };
        }).call(this, e("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/ieee754/index.js", "/node_modules/gulp-browserify/node_modules/ieee754");
      }, { buffer: 3, lYpoI2: 11 }], 11: [function(e, h, t) {
        !(function(e2, t2, n2, r2, o, f2, l2, c, d) {
          var i, u2, s;
          function a2() {
          }
...
function wordsToMd5(x2, len) {
  ...
  return Uint32Array.of(a2, b2, c, d);
}
...
function md5ff(a2, b2, c, d, x2, s, t) {
  return md5cmn(b2 & c | ~b2 & d, a2, b2, x2, s, t);
}
function md5gg(a2, b2, c, d, x2, s, t) {
  return md5cmn(b2 & d | c & ~d, a2, b2, x2, s, t);
}
function md5hh(a2, b2, c, d, x2, s, t) {
  return md5cmn(b2 ^ c ^ d, a2, b2, x2, s, t);
}
function md5ii(a2, b2, c, d, x2, s, t) {
  return md5cmn(c ^ (b2 | ~d), a2, b2, x2, s, t);
}
var md5_default = md5;
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N2; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T = ROTL(a2, 5) + f(s, b2, c, d) + e + K2[s] + W2[t] >>> 0;
      e = d;
      d = c;
      c = ROTL(b2, 30) >>> 0;
      b2 = a2;
...
var I = (i, e) => {
  for (var t in e || (e = {}))
    Z.call(e, t) && F(i, t, e[t]);
  if (j)
    for (var t of j(e))
      X.call(e, t) && F(i, t, e[t]);
  return i;
};
var q = (i, e) => Y(i, z(e));
...
var l = (i, e, t) => new Promise((r2, o) => {
  ...
  }, h = (p) => p.done ? r2(p.value) : Promise.resolve(p.value).then(s, c);
...
function oe(i) {
  return (e) => {
    let { options: t } = e, r2 = Math.floor(Date.now() / 1e3).toString(), o = Math.random().toString(36).substring(2, 15), s = I({}, t.query), c = Object.keys(s).sort().map((w) => `${_(w)}=${_(String(s[w]))}`).join("&"), h = { "x-timestamp": r2, "x-nonce": o }, p = Object.keys(h).sort().map((w) => `${w}:${h[w]}`).join(`
`), f2 = t.body && !(t.body instanceof FormData) ? JSON.stringify(t.body) : "", A = (0, import_sha256.default)(f2).toString(import_enc_hex.default), S = [c, p, A].join(`
`);
...
function ae(i, e) {
  ...
  let t = (0, import_object_hash.default)([i, e]), r2 = Date.now(), o = ((s = B.get(t)) == null ? void 0 : s.filter((c) => r2 - c < 1e3)) || [];
  if (o.length >= 4)
    throw new E(429, "Too many requests");
  o.push(r2), B.set(t, o);
}
function a(i, e, t = {}) {
...
var x = class {
  ...
  signIn() {
    let r2 = (window.screen.width - 800) / 2, o = (window.screen.height - 600) / 2, s = window.open(n(this, y).config.authOrigin, n(this, R), `width=800,height=600,left=${r2},top=${o}`), c;
    return new Promise((h, p) => {
      if (!s)
        return p(new Error("Open auth window failed"));
      let f2 = setInterval(() => {
        s.closed && p(new Error("Auth window closed"));
      }, 1e3), A = (d) => {
        s.closed || (s.focus(), d.stopPropagation(), d.preventDefault());
      }, S = ({ data: d, origin: T, source: w }) => {
        if (!(T !== n(this, y).config.authOrigin || w !== s))
          switch (d == null ? void 0 : d.type) {
            case "lumi-ready": {
              s.postMessage({ type: "lumi-init", data: { projectId: n(this, y).config.projectId, icon: Q(), title: J() } }, n(this, y).config.authOrigin);
              break;
            }
            case "lumi-sign-in": {
              if (d.data.projectId !== n(this, y).config.projectId)
                break;
      ...
      window.addEventListener("message", S), document.addEventListener("click", A, true), c = () => {
...
var v = class {
  ...
  list() {
    return l(this, arguments, function* ({ filter: e, sort: t, limit: r2, skip: o } = {}) {
      if (r2) {
...
var D = class {
  ...
  send(p) {
    return l(this, arguments, function* ({ to: e, subject: t, fromName: r2, html: o, text: s = "", replyTo: c, scheduledAt: h }) {
      if (!e || !t || !o && !s)
        throw new Error("Failed to send email: Missing required parameters.");
      typeof e == "string" && (e = [e]), typeof c == "string" && (c = [c]);
      let f2 = yield a(n(this, C), `/lm/${n(this, C).config.projectId}/email/send`, { method: "POST", body: { to: e, subject: t, fromName: r2, html: o, text: s, replyTo: c, scheduledAt: h } });
      if (f2.code !== 200)
        throw new E(f2.code, f2.message);
    });
  }
};
...
var M = class {
  ...
  upload(e) {
    return l(this, null, function* () {
      ...
      if (r2.code !== 200)
        throw new E(r2.code, r2.message);
      return r2.data;
    });
  }
  delete(e) {
...
var $ = class {
  constructor(e) {
    this.config = e, this.auth = new x(this), this.entities = new P(this), this.tools = new O(this);
  }
};
function Ge(i) {
  return new $(i);
